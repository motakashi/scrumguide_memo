...
- 中止はできるか？
  - スプリントゴールがもはや役に⽴たなくなった場合、可能かもしれない。プロダクトオーナーだけがスプリントを中⽌する権限を持つ。
...
- 確認すること
  ...
  - トピック 2 ：このスプリントで何ができるのか？次のスプリントのスプリントバックログに追加する
こともできる
    - 開発者は、プロダクトオーナーとの話し合いを通じて、PBLからアイテムを選択し、今回のスプリントに含める。
...
## デイリースクラム
計画された今後の作業を調整しながら、スプリントゴールに対する進捗を検査し、必要に応じてスプリントバックログを適応さる
- 時間
  - 毎日15分（同じ時間・同じ場所）
- 進め方
  - 開発者は、デイリースクラムがスプリントゴールの進捗に焦点をあて、これからの1⽇の作業の実⾏可能な計画を作成・共有する。（集中を⽣み出し、⾃⼰管理を促進する。また、コミュニケーションを生み出し、会議を減らせる）
  - POまたはScMがスプリントバックログのアイテムに積極的に取り組んでいる場合は、開発者として参加する
- 補足
...
- 1スプリント内でスクラムチームが完成できるプロダクトバックログアイテムは、スプリントプランニングのときには選択の準備ができている。
...
- 開発者がトレードオフを理解して選択できるように、プロダクトオーナーが開発者を⽀援することもできる。
...
- 作業が予想と異なることが判明した場合は、スプリントゴールに影響を与えることがないように、POと交渉してスプリントバックログのスコープを調整する。
